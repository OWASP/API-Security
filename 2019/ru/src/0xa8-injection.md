...
API уязвимо к инъекциям если:

* Данные, поступившие от пользователя, не валидируются, фильтруются или очищаются на стороне API.
...
* Данные поступающие из внешних систем (например, интегрированных систем) не валидируются, фильтруются или очищаются на стороне API.
