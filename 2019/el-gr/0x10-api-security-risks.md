...
| :-: | :-: | :-: | :-: | :-: | :-: |
| Εξαρτάται από το API | Εύκολη: **3** | Διαδεδομένος **3** | Εύκολη **3** | Σοβαρός **3** | Εξαρτάται από την Επιχείρηση |
| Εξαρτάται από το API | Μεσαία: **2** | Κοινός **2** | Μεσαία **2** | Μεσαίος **2** | Εξαρτάται από την Επιχείρηση |
| Εξαρτάται από το API | Δύσκολη: **1** | Δύσκολος **1** | Δύσκολη **1** | Μικρός **1** | Εξαρτάται από την Επιχείρηση |
