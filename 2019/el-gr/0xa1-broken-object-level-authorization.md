...
| Παράγοντες Απειλής/Φορείς επίθεσης | Security Weakness | Επιπτώσεις |
| - | - | - |
| API Specific : Εκμεταλλευσιμότητα **3** | Prevalence **3** : Ανιχνευσιμότητα **2** | Τεχνικές **3** : Εξαρτάται από την Επιχείρηση |
