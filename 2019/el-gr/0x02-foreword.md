...
Από τη φύση τους, τα API εκθέτουν τη λογική της εφαρμογής και τα ευαίσθητα δεδομένα, 
...
Παρόλο που μια ευρύτερη εφαρμογή διαδικτύου ενέχει κινδύνους ασφάλειας Το Top 10 
εξακολουθεί να έχει νόημα, λόγω της ιδιαίτερης φύσης τους, απαιτείται μια λίστα 
...
τις ομοιότητες μεταξύ των δύο εγγράφων: προορίζονται για αναγνωσιμότητα 
και υιοθέτηση. Εάν είστε νέος στη σειρά OWASP Top 10, ίσως είναι καλύτερα 
...
το έργο με την προσπάθεια και τη συνεισφορά τους. Όλα αναφέρονται στην ενότητα 
